@tool
@icon("res://resources/editor/audio_stacking_2d.svg")
class_name AudioStacking2D
...
static func _override_sound_positioned(audio_streams, audio_resource, position, volume_dB = 0.0, pitch_scale = 1.0, bus = "Master"):
